...
class StationTest {
    ...
    void testEquals() {
        ...
        assertNotEquals(station, station2);
        station2.setRegionalbereich(new Regionalbereich());
        assertNotEquals(station, station2);
        station2.setCreatedAt(LocalDateTime.now());
        assertNotEquals(station, station2);
        station2.setFederalState("federalState2");
        assertNotEquals(station, station2);
        station2.setHasCarRental(false);
        assertNotEquals(station, station2);
        station2.setHasDBLounge(false);
        assertNotEquals(station, station2);
        station2.setHasLostAndFound(false);
        assertNotEquals(station, station2);
        station2.setHasRailwayMission(false);
        assertNotEquals(station, station2);
        station2.setHasTravelCenter(false);
        assertNotEquals(station, station2);
        station2.setHasWiFi(false);
        assertNotEquals(station, station2);
        station2.setHasMobilityService("hasMobilityService2");
        assertNotEquals(station, station2);
        station2.setHasSteplessAccess("hasSteplessAccess2");
        assertNotEquals(station, station2);
        station2.setHasTravelNecessities(false);
        assertNotEquals(station, station2);
        station2.setHasTaxiRank(false);
        assertNotEquals(station, station2);
        station2.setHasLockerSystem(false);
        assertNotEquals(station, station2);
        station2.setHasPublicFacilities(false);
        assertNotEquals(station, station2);
        station2.setHasLocalPublicTransport(false);
        assertNotEquals(station, station2);
        station2.setHasBicycleParking(false);
        assertNotEquals(station, station2);
        station2.setHasParking(false);
        assertNotEquals(station, station2);
        station2.setPriceCategory(2.0f);
        assertNotEquals(station, station2);
        station2.setCategory(2.0f);
        assertNotEquals(station, station2);
        station2.setAddress(new Address());
        assertNotEquals(station, station2);
        station2.setOperator(new Operator());
        assertNotEquals(station, station2);
        station2.setLocation(new Location());
        assertNotEquals(station, station2);
        station2.setName("name2");
        assertNotEquals(station, station2);
        station2.setNr(5.0f);
        assertNotEquals(station, station2);
        station2.setRil100("ril1002");
        assertNotEquals(station, station2);
        station2.setType("type2");
        assertNotEquals(station, station2);
        station2.setWeight(4.0f);
        assertNotEquals(station, station2);
        station2.setScore(3.0f);
        assertNotEquals(station, station2);
        station2.setId("id2");
        assertNotEquals(station, station2);
        station2.setUuid(UUID.randomUUID());
        assertNotEquals(station, station2);
    }
